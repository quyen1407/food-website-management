                    ...
                    <div class="checkout__order">
                        ...
                        <table class="table">
                            ...
                            foreach ($cart as $item) {
                                ...
                                ?>
                                <form action="suagiohang.php?id=<?= $item['id'] ?>" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-warning" style="margin-top: 0px;">Cập nhật</button></td>
                                        <td><a href='./xoagiohang.php?id=<?= $item['id'] ?>' class="btn btn-danger">Xóa</a>
                                        </td>
                                    </tr>
                                </form>
...
<?php 
    require_once('nguoidung/footer.php');
 ?>