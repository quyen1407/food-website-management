    ...
    <section class="featured spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <!-- xử lý phần sản phẩm đặc trưng -->
                        <h2>Sản Phẩm Đăc Trưng</h2>
                    </div>
            ...
            <div class="row featured__filter">
                <!-- từng phần sản phẩm của danh mục sản phẩm -->
                <?php
                ...
                <!-- cho hiển thị theo từng sản phẩm -->
    ...
    <section class="from-blog spad">
        <div class="container">
            ...
            <div class="row">
                <?php
                // thêm phần tin tức 
                $sql_str = "select * from news order by created_at desc limit 0,5";
                $result = mysqli_query($conn,$sql_str);
                while ($row = mysqli_fetch_assoc($result)) {
                ?>
